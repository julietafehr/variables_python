...
nombre_y_apellido = str(input("Ingrese su nombre y apellido completos: "))
dni = int(input("Ingrese su numero de documento sin puntos: "))
edad = int(input("Ingrese su edad: "))
altura = float(input("Ingrese su altura: "))

print(f"Nombre completo: {nombre_y_apellido}, DNI: {dni}")
print(f"Nombre completo: {nombre_y_apellido}, Edad: {edad}, Altura: {altura}")
