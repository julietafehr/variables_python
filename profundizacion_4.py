...
nombreyapellido_paterno = input("Ingrese el nombre y apellido de su padre: ")
nombreyapellido_materno = input("Ingrese el nombre y apellido de su madre: ")
nombre = input("Ingrese su nombre: ")

datos_paternos = nombreyapellido_paterno.split()
datos_maternos = nombreyapellido_materno.split()

nombre_completo = nombre + " " + (datos_paternos[1]) + " " + (datos_maternos[1])
